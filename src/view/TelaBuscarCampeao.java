...
public class TelaBuscarCampeao extends javax.swing.JFrame {
     ...
     */
    public TelaBuscarCampeao() {
        initComponents();
    }
    
    public void listaCampeoes(){
        try{
    ...
    private void initComponents() {
        ...
        tabelaCampeoes = new javax.swing.JTable();
        ...
        buscaJogador.setText("BUSCAR CAMPEÃO");
        ...
        tabelaCampeoes.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
            ...
            new String [] {
                "NOME", "FUNÇÃO", "DIFICULDADE", "HABILIDADE"
            }
        ));
        tabelaCampeoes.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tabelaCampeoesMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tabelaCampeoes);
        ...
        jLabel1.setText("Selecione um campeão para Editar ou Excluir!");

        jLabelNomePesquisa.setFont(new java.awt.Font("Segoe UI Black", 0, 12)); // NOI18N
        jLabelNomePesquisa.setText("       Nome");
        jLabelNomePesquisa.setAlignmentX(0.5F);
        jLabelNomePesquisa.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(153, 153, 153)));
        jLabelNomePesquisa.setPreferredSize(new java.awt.Dimension(40, 19));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(jLabelNomePesquisa, javax.swing.GroupLayout.PREFERRED_SIZE, 84, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jLabelNomePesquisa, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(40, 40, 40)
    ...
    private void txtPesquisaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPesquisaKeyReleased
        ...
        tabelaCampeoes.setAutoCreateRowSorter(true);
    }//GEN-LAST:event_txtPesquisaKeyReleased

    private void tabelaCampeoesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaCampeoesMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_tabelaCampeoesMouseClicked

    private void buttonEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonEditarActionPerformed
        if (tabelaCampeoes.getSelectedRow() != -1) {
            int linha = tabelaCampeoes.getSelectedRow();
            String nome = (String) tabelaCampeoes.getValueAt(linha, 0);
            
            Campeao campeaoSelecionado = controle.buscarCampeao(nome);
            
            if (campeaoSelecionado != null) {
                TelaCampeao telaCampeao = new TelaCampeao(); //envia os dados do campeão selecionado para a telaCampeao
                telaCampeao.recebeDadosCampeao(campeaoSelecionado);
                telaCampeao.setVisible(true);
                this.dispose();
            } else {
                JOptionPane.showMessageDialog(this, "Campeão não encontrado.");
            }
        } else {
            JOptionPane.showMessageDialog(this, "Selecione um campeão para editar.");
        }
    }//GEN-LAST:event_buttonEditarActionPerformed

    private void buttonExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonExcluirActionPerformed
      int confirma = JOptionPane.showConfirmDialog(this, "Tem certeza de que deseja excluir campeão?", "CONFIRMAÇÃO DE EXCLUSÃO", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);

        if(confirma == JOptionPane.YES_OPTION){
            if(tabelaCampeoes.getSelectedRow() != -1){
                String nome = (String) tabelaCampeoes.getValueAt(tabelaCampeoes.getSelectedRow(), 0);
                
                controle.removerCampeao(nome);
                carregarTabela();
                JOptionPane.showMessageDialog(this, "Campeão excluído com sucesso!");
            }else{
                JOptionPane.showMessageDialog(this, "Selecione um campeão para excluir!");
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaBuscarCampeao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaBuscarCampeao().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tabelaCampeoes;
